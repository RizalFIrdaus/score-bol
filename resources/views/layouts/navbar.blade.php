<nav class="bg-[#F7F9FB] border-gray-200 px-2 sm:px-4 py-2.5 rounded shadow-lg">
    <div class="sm:container sm:px-10 flex flex-wrap items-center justify-between mx-auto">
        <a href="{{ url('/') }}" class="flex items-center">
            ...
            <span class="self-center text-xl md:text-3xl lg:text-2xl font-semibold whitespace-nowrap">Score Bol</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1 "
            ...
            <ul
                ...
                <li>
                    <a href="{{ route("match") }}"
                        class="block py-2 pl-3 pr-4  rounded hover:bg-slate-600 hover:text-white lg:hover:bg-transparent lg:hover:text-[#fee74c] lg:p-0 lg:text-md font-bold text-slate-600  ">Score</a>
                </li>
                <li>
                    <a href="{{ route("club") }}"
                        class="block py-2 pl-3 pr-4  rounded hover:bg-slate-600 hover:text-white lg:hover:bg-transparent lg:hover:text-[#fee74c] lg:p-0 lg:text-md font-bold text-slate-600  ">Data Klub</a>
                </li>
            </ul>
        </div>
    </div>
